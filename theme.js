...
export default {
  ...
  colors: {
    ...
    secondary: 'var(--color-secondary, hsl(212, 23%, 69%))',
    accent: 'var(--color-accent, #fff)',
    'base-light': 'var(--color-base-light, hsl(210, 46%, 95%))',
    primary: 'var(--color-primary, hsl(217, 19%, 35%))',
  },
  fontSize: {
    'step-3':
      'var(--fontSize-step-3, clamp(1.2148rem, 0.718rem + 1.2419vw, 1.5128rem))',
    'step-2':
      'var(--fontSize-step-2, clamp(1.1385rem, 0.7948rem + 0.8593vw, 1.3447rem))',
    'step-1':
      'var(--fontSize-step-1, clamp(1.067rem, 0.8531rem + 0.5346vw, 1.1953rem))',
    'step-0':
